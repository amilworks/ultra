...
func TestV2AdminAndTrainingReadEndpointsAreOwnedByGo(t *testing.T) {
	...
	cases := []struct {
		...
		{path: "/v2/training/models/yolov5_rarespot/status", wantKeys: []string{"dataset_name", "model_health", "retrain_gate_reasons"}, statusCode: http.StatusOK},
		{path: "/v2/training/models/yolov5_rarespot/retrain-requests", wantKeys: []string{"count", "requests"}, statusCode: http.StatusOK},
