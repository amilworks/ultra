...
def test_run_trace_passes_operator_auth_headers_from_env(monkeypatch):
    ...
    monkeypatch.setenv("TRACE_COOKIE", "ultra_workos_session=sealed-session")
    ...
    assert captured["extra_headers"] == {
        ...
        "Cookie": "ultra_workos_session=sealed-session",
    }
...
def test_control_plane_client_sends_operator_auth_headers(monkeypatch):
    ...
    assert captured_headers["Cookie"] == "ultra_workos_session=sealed-session"
