...
def generate_css_files(root=None, public=None):
    ...
    return stylesheet_link(
        ...
        "/core/plugins/table/table.css",
        "/core/plugins/text/ResourceText.css",
        "/core/plugins/pipeline/ResourcePipeline.css",
        "/core/plugins/system/ResourceSystem.css",
        "/core/plugins/branding/branding.css",
...
def generate_js_files(root=None, public=None):
    ...
    return javascript_link(
        ...
        # !!! Resolved the paths manually
        "/core/plugins/table/table.js",
        "/core/plugins/text/ResourceText.js",
