...
request = '%s<value>%s</value>'%(request, localpath2url('f:/dima/develop/python/bq5irods/data/imagedir/admin/tests/multi_file/series_z_tiff/z_000001.tiff'))
request = '%s<value>%s</value>'%(request, localpath2url('f:/dima/develop/python/bq5irods/data/imagedir/admin/tests/multi_file/series_z_tiff'))
request = '%s<tag name="%s" type="%s">'%(request, 'image_meta', 'image_meta')
request = '%s<tag name="%s" value="%s" type="number" />'%(request, 'image_num_z', '30')
request = '%s<tag name="%s" value="%s" type="number" />'%(request, 'image_num_t', '1')
...
request = '%s<tag name="%s" value="%s" type="number" />'%(request, 'pixel_resolution_z', '0.8')
...
request = '%s<tag name="%s" value="%s" />'%(request, 'pixel_resolution_unit_z', 'micron')
