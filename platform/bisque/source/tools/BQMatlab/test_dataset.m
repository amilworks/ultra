...
members = {
    'https://bisque.example.com/data_service/00-wSNHBdiTN2fdcSSehpfDZc', ...
    'https://bisque.example.com/data_service/00-CfZ5UrFh5teejLCyyYR3aV', ...
    'https://bisque.example.com/data_service/00-A3cQsLxCBupcbuDNPxCNLP'
};
